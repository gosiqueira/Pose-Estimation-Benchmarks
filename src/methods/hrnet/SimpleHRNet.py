...
class SimpleHRNet:
    ...
    def __init__(self,
                 ...
                 max_batch_size=32,
                 yolo_model_def="./methods/hrnet/models/detectors/yolo/config/yolov3.cfg",
                 yolo_class_path="./methods/hrnet/models/detectors/yolo/data/coco.names",
                 yolo_weights_path="./methods/hrnet/models/detectors/yolo/weights/yolov3.weights",
