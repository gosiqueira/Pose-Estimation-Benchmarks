...
POSE_ESTIMATORS = ['AlphaPoseMXNet', 'DetectronCocoKeypoints', 'SimpleBaselineMXNet', 'HRNet']

def get_args():
    parser = argparse.ArgumentParser()
    
    parser.add_argument('-m', '--method', help='Pose estimator method name', type=str, choices=['AlphaPoseMXNet', 'DetectronCocoKeypoints', 'SimpleBaselineMXNet', 'HRNet', 'all'], default='all')
