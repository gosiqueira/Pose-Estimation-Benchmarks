...
POSE_ESTIMATORS = ['AlphaPoseMXNet', 'DetectronCocoKeypoints', 'SimpleBaselinesMXNet', 'HRNet']

def get_args():
    parser = argparse.ArgumentParser()
    
    parser.add_argument('-m', '--method', help='Pose estimator method name', type=str, choices=['AlphaPoseMXNet', 'DetectronCocoKeypoints', 'SimpleBaselinesMXNet', 'HRNet', 'all'], default='all')
...
if __name__ == '__main__':
    ...
    if args.method == 'all':
        ...
        gen_benchmark(args.method, args.video_folder)
